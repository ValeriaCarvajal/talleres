                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" name="update_register" id="update_register" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="dni" class="col-sm-2 control-label">Id: </label>
                                    <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="imagefile" class="col-sm-2 control-label">Referencia: </label>
                                    <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        <button type="submit" class="btn btn-primary actualizar_datos">Guardar</button>
                                    </div>
                                </div>
                            </form>
                        </div>
